...
1. Настройка системы координат в начале программы (5.3.1)
2. ~~Обработка карманов с уклонными стенками (3.3.1)~~
3. Ручной и автоматический ремонт контуров из DXF (5.2.1)
4. Фрезеровка под крепеж (2.1.1)
5. Фрезеровка с зенковкой (2.1.2)
6. Фрезеровка с рассверловкой (2.1.3)
7. Черновая и чистовая обработка кармана (3.1.3)
