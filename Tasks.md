...
1. ~~Настройка системы координат в начале программы (5.3.1)~~ ~~_[**v.0.6.1**]_~~
...
7. ~~Выход и старт с позиции смены инструмента (для станков без автосмены, в основном что-то а-ля 3018)~~
