...
2. Черновая и чистовая обработка кармана (3.1.3) [**v.0.6.2**]
3. Фрезеровка под крепеж (2.1.1) [**v.0.6.3**]
4. Фрезеровка с зенковкой (2.1.2) [**v.0.6.4**]
5. Фрезеровка с рассверловкой (2.1.3) [**0.6.5**]
6. Ручной и автоматический ремонт контуров из DXF (5.2.1) [**v.0.6.6**]
