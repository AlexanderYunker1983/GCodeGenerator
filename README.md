Продукт находится в стадии доработки: выполняется план рефакторинга и обновления используемого стека (см. [Plan.md](Plan.md)).
Релизная версия продукта будет выпущена после завершения всех работ по плану.
Текущая версия — 0.0.1 (базовая, до начала доработок).
После завершения работ в WPF планируется кроссплатформенность и большая интерактивность работы с 2D/3D.
