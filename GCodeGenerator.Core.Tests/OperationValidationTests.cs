...
namespace GCodeGenerator.Tests
{
    ...
    public class OperationValidationTests
    {
        ...
        /// и для поверхности ниже нуля отвод тоже ниже нуля. Проверять это
        /// на отверстии с нулевым верхом было нельзя: там отвод «минус
        /// полтора» означает не низко расположенную поверхность, а уход
        /// сверла глубже пройденного.
        /// </summary>
        [TestMethod]
