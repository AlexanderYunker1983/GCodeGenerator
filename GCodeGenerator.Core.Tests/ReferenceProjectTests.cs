...
namespace GCodeGenerator.Tests
{
    ...
    ///
    /// Снимает с ручного прогона сверку программы с эталоном: эталон лежит
    /// в репозитории, а сравнение выполняется на каждой сборке. Ручной прогон
    /// (docs/SMOKE_CHECKLIST.md) занят тем, чего тесты не видят, — окном,
    /// предпросмотром и установкой.
    ///
