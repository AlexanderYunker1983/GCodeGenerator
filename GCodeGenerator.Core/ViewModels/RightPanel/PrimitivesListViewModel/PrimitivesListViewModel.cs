...
public partial class PrimitivesListViewModel : ViewModelBase, IHasDisplayName
{
    ...
    public PrimitivesListViewModel(Preview2DViewModelNamespace.Preview2DViewModel preview2DViewModel)
    {
        ...
        Primitives.Add(new PointPrimitive("Точка", 0, 0));
        Primitives.Add(new LinePrimitive("Линия", 0, 0, 10, 0));
        Primitives.Add(new CirclePrimitive("Круг", 0, 0, 5));
        Primitives.Add(new RectanglePrimitive("Прямоугольник", 0, 0, 10, 5, 0));
        Primitives.Add(new EllipsePrimitive("Эллипс", 0, 0, 8, 4, 0));
        Primitives.Add(new ArcPrimitive("Дуга", 0, 0, 5, 0, 90));
        Primitives.Add(new PolygonPrimitive("Многогранник", 0, 0, 5, 6, 0));

        var dxf = new DxfPrimitive("DXF-объект", 0, 0, "demo.dxf", 0);
        dxf.Children.Add(new LinePrimitive("DXF-линия", -5, -5, 5, 5));
        Primitives.Add(dxf);

        var composite = new CompositePrimitive("Составной объект", 5, 5, 0);
