...
namespace GCodeGenerator.Models
{
    ...
    public enum ValidationCode
    {
        ...
        /// <summary>
        /// Значение должно быть строго выше предела. Так задаются высоты,
        /// на которых инструмент идёт над заготовкой: равенство означает
        /// перемещение вплотную к материалу, а не над ним.
        /// </summary>
        NotAbove,
