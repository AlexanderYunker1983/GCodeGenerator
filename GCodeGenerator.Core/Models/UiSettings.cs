...
namespace GCodeGenerator.Models
{
    ...
    public class UiSettings
    {
        ...
        ///
        /// Выключено по умолчанию намеренно: это единственное обращение
        /// программы к сети, и делать его без спроса она не должна.
        /// Согласие даётся здесь; отдельная кнопка в окне «О программе»
        /// проверяет по требованию и согласия не требует — нажатие
        /// и есть согласие.
        /// </summary>
