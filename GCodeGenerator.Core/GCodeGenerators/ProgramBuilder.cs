...
namespace GCodeGenerator.GCodeGenerators
{
    ...
    public class ProgramBuilder
    {
        ...
        /// <summary>
        /// Adds a preformatted line verbatim as a raw block. Used as a bridge
        /// for the legacy string-based operation generators (plan item 4.4
        /// ports them to structured calls) and for fixed marker lines.
        /// </summary>
        ...
        /// when <paramref name="rpm"/> has a value (0 is a valid speed).
        /// </summary>
        ...
        /// <summary>
        /// Program header marker line. Legacy behavior: it is emitted even
        /// when comments are disabled, hence a raw line (not a comment block).
        /// </summary>
        public void Header()
        {
            RawLine("(Generated by GCodeGenerator)");
        }

        /// <summary>
        /// Безопасный пролог: единицы (G21 — миллиметры), абсолютные координаты
        /// (G90), плоскость обработки (G17 — XY), подача в минуту (G94), отмена
        /// коррекции радиуса (G40), коррекции длины инструмента (G49) и
        /// постоянного цикла (G80).
        ///
        /// Все эти состояния модальные: стойка помнит их от предыдущей
        /// программы. Без пролога один и тот же файл выполнялся по-разному
        /// в зависимости от того, что запускали до него: программа выводит
        /// абсолютные координаты в миллиметрах и подачи в мм/мин, но нигде
        /// об этом не заявляла, и после чужой программы в дюймах или
        /// в приращениях траектория получалась совсем другой.
        /// </summary>
        public void SafetyPreamble()
        {
            AddCode(GCodeWord.G(21), GCodeWord.G(90), GCodeWord.G(17), GCodeWord.G(94));
            AddCode(GCodeWord.G(40), GCodeWord.G(49), GCodeWord.G(80));
        }
