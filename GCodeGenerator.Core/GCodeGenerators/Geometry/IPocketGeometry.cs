...
namespace GCodeGenerator.GCodeGenerators.Geometry
{
    ...
    public interface IPocketGeometry
    {
        ...
        /// безопасную высоту. Это требуется не только областям с островами:
        /// прямой отрезок между двумя внутренними точками вогнутого контура
        /// также может выйти через сохраняемый материал.
        /// </summary>
        bool RequiresSafeTransitions => false;
